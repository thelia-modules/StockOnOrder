 ...
 *
 */
class StockOnOrderTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'StockOnOrder.Model.Map.StockOnOrderTableMap';
     ...
     */
    const TABLE_NAME = 'stock_on_order';

    /**
     * The related Propel class for this table
     */
    const OM_CLASS = '\\StockOnOrder\\Model\\StockOnOrder';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'StockOnOrder.Model.StockOnOrder';
    ...
    {
        return $withPrefix ? StockOnOrderTableMap::CLASS_DEFAULT : StockOnOrderTableMap::OM_CLASS;
    }
     ...
     * @return array (StockOnOrder object, last column rank)
     */
    public static function populateObject($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        $key = StockOnOrderTableMap::getPrimaryKeyHashFromRow($row, $offset, $indexType);
        if (null !== ($obj = StockOnOrderTableMap::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $offset, true); // rehydrate
            $col = $offset + StockOnOrderTableMap::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = StockOnOrderTableMap::OM_CLASS;
            $obj = new $cls();
            $col = $obj->hydrate($row, $offset, false, $indexType);
            StockOnOrderTableMap::addInstanceToPool($obj, $key);
        }
    ...
    public static function populateObjects(DataFetcherInterface $dataFetcher)
    {
        ...
        while ($row = $dataFetcher->fetch()) {
            $key = StockOnOrderTableMap::getPrimaryKeyHashFromRow($row, 0, $dataFetcher->getIndexType());
            if (null !== ($obj = StockOnOrderTableMap::getInstanceFromPool($key))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
    ...
    {
        return Propel::getServiceContainer()->getDatabaseMap(StockOnOrderTableMap::DATABASE_NAME)->getTable(StockOnOrderTableMap::TABLE_NAME);
    }
    ...
    /**
     * Performs a DELETE on the database, given a StockOnOrder or Criteria object OR a primary key value.
     *
     * @param mixed               $values Criteria or StockOnOrder object or primary key or array of primary keys
    ...
    {
        return StockOnOrderQuery::create()->doDeleteAll($con);
    }

    /**
     * Performs an INSERT on the database, given a StockOnOrder or Criteria object.
     *
     * @param mixed               $criteria Criteria or StockOnOrder object containing data that is used to create the INSERT statement.
...
//
StockOnOrderTableMap::buildTableMap();
