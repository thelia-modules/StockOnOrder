...
abstract class StockOnOrder implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\StockOnOrder\\Model\\Map\\StockOnOrderTableMap';
    ...
    /**
     * Initializes internal state of StockOnOrder\Model\Base\StockOnOrder object.
     */
    ...
    /**
     * Compares this with another <code>StockOnOrder</code> instance.  If
     * <code>obj</code> is an instance of <code>StockOnOrder</code>, delegates to
     * <code>equals(StockOnOrder)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return StockOnOrder The current object, for fluid interface
     */
    ...
    public function setOrderId($v)
    {
        ...
        if ($this->order_id !== $v) {
            $this->order_id = $v;
            $this->modifiedColumns[StockOnOrderTableMap::ORDER_ID] = true;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildStockOnOrderQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see StockOnOrder::setDeleted()
     * @see StockOnOrder::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        try {
            $deleteQuery = ChildStockOnOrderQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                StockOnOrderTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        $sql = sprintf(
            'INSERT INTO stock_on_order (%s) VALUES (%s)',
    ...
    {
        $pos = StockOnOrderTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['StockOnOrder'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \StockOnOrder\Model\StockOnOrder (or compatible) type.
     ...
     *
     * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return                 \StockOnOrder\Model\StockOnOrder Clone of current object.
     * @throws PropelException
     */
    ...
    public function getOrder(ConnectionInterface $con = null)
    {
        if ($this->aOrder === null && ($this->order_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aOrder->addStockOnOrders($this);
             */
        }
    ...
    {
        return (string) $this->exportTo(StockOnOrderTableMap::DEFAULT_STRING_FORMAT);
    }
