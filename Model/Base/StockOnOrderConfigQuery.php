...
use StockOnOrder\Model\StockOnOrderConfig as ChildStockOnOrderConfig;
...
/**
 * Base class that represents a query for the 'stock_on_order_config' table.
 *
 *
 *
 * @method     ChildStockOnOrderConfigQuery orderById($order = Criteria::ASC) Order by the id column
 ...
 * @method     ChildStockOnOrderConfigQuery innerJoin($relation) Adds a INNER JOIN clause to the query
 *
 * @method     ChildStockOnOrderConfigQuery leftJoinModule($relationAlias = null) Adds a LEFT JOIN clause to the query using the Module relation
 * @method     ChildStockOnOrderConfigQuery rightJoinModule($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Module relation
 * @method     ChildStockOnOrderConfigQuery innerJoinModule($relationAlias = null) Adds a INNER JOIN clause to the query using the Module relation
 *
 * @method     ChildStockOnOrderConfigQuery leftJoinOrderStatus($relationAlias = null) Adds a LEFT JOIN clause to the query using the OrderStatus relation
 * @method     ChildStockOnOrderConfigQuery rightJoinOrderStatus($relationAlias = null) Adds a RIGHT JOIN clause to the query using the OrderStatus relation
 * @method     ChildStockOnOrderConfigQuery innerJoinOrderStatus($relationAlias = null) Adds a INNER JOIN clause to the query using the OrderStatus relation
 *
 * @method     ChildStockOnOrderConfig findOne(ConnectionInterface $con = null) Return the first ChildStockOnOrderConfig matching the query
 * @method     ChildStockOnOrderConfig findOneOrCreate(ConnectionInterface $con = null) Return the first ChildStockOnOrderConfig matching the query, or a new ChildStockOnOrderConfig object populated from the query conditions when no match is found
 *
 * @method     ChildStockOnOrderConfig findOneById(int $id) Return the first ChildStockOnOrderConfig filtered by the id column
...
abstract class StockOnOrderConfigQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'thelia', $modelName = '\\StockOnOrder\\Model\\StockOnOrderConfig', $modelAlias = null)
    {
        parent::__construct($dbName, $modelName, $modelAlias);
    }

    /**
     * Returns a new ChildStockOnOrderConfigQuery object.
     *
     * @param     string $modelAlias The alias of a model in the query
     * @param     Criteria $criteria Optional Criteria to build the query from
     *
     * @return ChildStockOnOrderConfigQuery
     */
    public static function create($modelAlias = null, $criteria = null)
    {
        if ($criteria instanceof \StockOnOrder\Model\StockOnOrderConfigQuery) {
            return $criteria;
        }
        $query = new \StockOnOrder\Model\StockOnOrderConfigQuery();
        if (null !== $modelAlias) {
     ...
     *
     * @return ChildStockOnOrderConfig|array|mixed the result, formatted by the current formatter
     */
    public function findPk($key, $con = null)
    {
        ...
        if ((null !== ($obj = StockOnOrderConfigTableMap::getInstanceFromPool((string) $key))) && !$this->formatter) {
     ...
     *
     * @return   ChildStockOnOrderConfig A model object, or null if the key is not found
     */
    protected function findPkSimple($key, $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            $obj = new ChildStockOnOrderConfig();
            $obj->hydrate($row);
            StockOnOrderConfigTableMap::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(StockOnOrderConfigTableMap::ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(StockOnOrderConfigTableMap::ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(StockOnOrderConfigTableMap::ID, $id, $comparison);
    }
    ...
    public function filterByModuleId($moduleId = null, $comparison = null)
    {
        if (is_array($moduleId)) {
            ...
            if (isset($moduleId['min'])) {
                $this->addUsingAlias(StockOnOrderConfigTableMap::MODULE_ID, $moduleId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($moduleId['max'])) {
                $this->addUsingAlias(StockOnOrderConfigTableMap::MODULE_ID, $moduleId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(StockOnOrderConfigTableMap::MODULE_ID, $moduleId, $comparison);
    }
    ...
    public function filterByStatusId($statusId = null, $comparison = null)
    {
        if (is_array($statusId)) {
            ...
            if (isset($statusId['min'])) {
                $this->addUsingAlias(StockOnOrderConfigTableMap::STATUS_ID, $statusId['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($statusId['max'])) {
                $this->addUsingAlias(StockOnOrderConfigTableMap::STATUS_ID, $statusId['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(StockOnOrderConfigTableMap::STATUS_ID, $statusId, $comparison);
    }
     ...
     * $query->filterByBehavior('%fooValue%'); // WHERE behavior LIKE '%fooValue%'
     * </code>
     *
    ...
    public function filterByModule($module, $comparison = null)
    {
        if ($module instanceof \Thelia\Model\Module) {
            return $this
                ->addUsingAlias(StockOnOrderConfigTableMap::MODULE_ID, $module->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(StockOnOrderConfigTableMap::MODULE_ID, $module->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
    ...
    public function filterByOrderStatus($orderStatus, $comparison = null)
    {
        if ($orderStatus instanceof \Thelia\Model\OrderStatus) {
            return $this
                ->addUsingAlias(StockOnOrderConfigTableMap::STATUS_ID, $orderStatus->getId(), $comparison);
            ...
            return $this
                ->addUsingAlias(StockOnOrderConfigTableMap::STATUS_ID, $orderStatus->toKeyValue('PrimaryKey', 'Id'), $comparison);
        } else {
     ...
     *
     * @param   ChildStockOnOrderConfig $stockOnOrderConfig Object to remove from the list of results
     *
     * @return ChildStockOnOrderConfigQuery The current query, for fluid interface
     */
    public function prune($stockOnOrderConfig = null)
    {
        if ($stockOnOrderConfig) {
            $this->addUsingAlias(StockOnOrderConfigTableMap::ID, $stockOnOrderConfig->getId(), Criteria::NOT_EQUAL);
        }
    ...
    /**
     * Performs a DELETE on the database, given a ChildStockOnOrderConfig or Criteria object OR a primary key value.
     *
     * @param mixed               $values Criteria or ChildStockOnOrderConfig object or primary key or array of primary keys
